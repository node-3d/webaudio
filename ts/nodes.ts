...
const scheduledDescs = ['AudioBufferSourceNode', 'OscillatorNode'] as const;

type TNodeConstructor<TInstance extends object = TAudioNode> = new (
	ctx: TBaseAudioContext,
	opts?: TAudioNodeOptions,
) => TInstance;
type TNativeNodeConstructor = TNativeConstructor<
	[ctx: TBaseAudioContext, paramCtor: typeof AudioParam, opts: TAudioNodeOptions],
	object
>;
...
} & Record<TExportedNodeName, TNodeConstructor> &
	Record<string, TNodeConstructor>;
